...
interface QueryBuilderInterface
{
    ...
    function orWhereNot(string $column, string $operator, string|null $value) : self;
    ...
    function whereAny(array $columns, string $operator, string|null $value) : self;
    function whereAll(array $columns, string $operator, string|null $value) : self;
    function whereNone(array $columns, string $operator, string|null $value) : self;
